<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reprintpassenger.aspx.cs" Inherits="Reprintpassenger" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="pId"
                        ...
                        <Columns>
                            <asp:TemplateField SortExpression="FName">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="Label14" runat="server" Font-Bold="True" Font-Names="@Arial Unicode MS"
                                        ...
                                        Width="288px" style="text-align: center" Height="48px"></asp:Label><br />
                                    <br />
                                    ...
                                    <asp:Label ID="Label12" runat="server" Text='<%# Bind("pId") %>' Font-Size="10pt" ForeColor="#330099"></asp:Label>
                                    &nbsp; &nbsp;<asp:Label ID="Label21" runat="server" ForeColor="#330099" Text="Reservation ID:" Font-Size="10pt"></asp:Label>
                                    &nbsp;
                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("RID") %>' Font-Size="10pt" ForeColor="#330099"></asp:Label>
                                    &nbsp; &nbsp;&nbsp; 
                                    <asp:Label ID="Label23" runat="server" ForeColor="#330099" Text="Bus ID:" Font-Size="10pt"></asp:Label>
                                    <asp:Label ID="Label26" runat="server" Font-Size="10pt" ForeColor="#330099" Height="16px"
                                        Text='<%# Bind("RegNo") %>'></asp:Label>
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                                    <br />
                                    <br />
                                    <asp:Label ID="Label13" runat="server" Font-Names="@Arial Unicode MS" Font-Size="10pt"
                                        ForeColor="#330099" Text="Full name:"></asp:Label>
                                    &nbsp; &nbsp; &nbsp; &nbsp;<asp:Label ID="Label3" runat="server" Text='<%# Bind("Title") %>' Font-Size="10pt" ForeColor="#330099"></asp:Label>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("FName") %>' Font-Size="10pt" ForeColor="#330099"></asp:Label>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("LName") %>' Font-Size="10pt" ForeColor="#330099"></asp:Label>&nbsp;
                                    <br />
                                    <asp:Label ID="Label17" runat="server" ForeColor="#330099" Text="Depature:" Font-Size="10pt"></asp:Label>
                                    &nbsp; &nbsp; &nbsp; &nbsp;<asp:Label ID="Label7" runat="server" Text='<%# Bind("depaturePlace") %>' Font-Size="10pt" ForeColor="#330099"></asp:Label><br />
                                    <asp:Label ID="Label18" runat="server" ForeColor="#330099" Text="Arrival:" Font-Size="10pt"></asp:Label>
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Label ID="Label8" runat="server" Text='<%# Bind("ArivalPlace") %>' Font-Size="10pt" ForeColor="#330099"></asp:Label><br />
                                    <asp:Label ID="Label19" runat="server" ForeColor="#330099" Text="Date & Time:" Font-Size="10pt"></asp:Label>
                                    &nbsp;
                                    <asp:Label ID="Label9" runat="server" Text='<%# Bind("dDate", "{0:d}") %>' Font-Size="10pt" ForeColor="#330099"></asp:Label>
                                    <asp:Label ID="Label10" runat="server" Text='<%# Bind("dTime", "{0:t}") %>' Font-Size="10pt" ForeColor="#330099"></asp:Label>&nbsp;<br />
                                    &nbsp; &nbsp; &nbsp; &nbsp;
                                    <br />
                                    &nbsp; &nbsp; &nbsp;
                                    <br />
                                    ...
                                    <asp:Label ID="Label25" runat="server" Font-Bold="True" Font-Names="@Arial Unicode MS"
                                        Font-Size="9pt" ForeColor="#330099" Text="Thank You... come again..."></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="RegNo" SortExpression="RegNo" Visible="False">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label26" runat="server" Text='<%# Bind("RegNo") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BusReservationConnectionString %>"
                        SelectCommand="SELECT * FROM [Printticket] WHERE ([pId] = @pId)">
                        <SelectParameters>
                            <asp:SessionParameter DefaultValue="1" Name="pId" SessionField="PID" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
                <td>
